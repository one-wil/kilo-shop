...
function buildCheckoutAnalyticsResult_(events, storeKey) {
  ...
  return {
    ...
    funnel:[
      ...
      {stage:6,label:'إرسال الطلب',sessions:purchases,rate:pct(purchases,sessionCount)}
    ],
